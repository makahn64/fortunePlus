...
adapter.findMany = function (model, query, limit, queryObj) {
  var _this = this;
  if (_.isArray(query)) {
...
/**
 * Convert colonized object to proper JS object. Example: animal:type:dog
 * becomes { animal: { type: dog }}. It is possible to get situations like:
 * { animal: null } if you passed ["animal"].
 * @param colonized
 * @private
 */
adapter._makeObjectFromColon = function(colonized){
    //TODO implement descenders
